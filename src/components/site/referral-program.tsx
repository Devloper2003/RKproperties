...
const STEPS = [
  ...
  { icon: Users, title: "They Book a Plot", desc: "Your referral books any RK Properties plot using your code at checkout." },
              ...
              <CardContent className="p-6 sm:p-8">
                ...
                <div className="pt-4 border-t border-gold/15">
                  ...
                  <div className="flex justify-center gap-2">
                    <a
                      href={`https://wa.me/?text=Namaste! 🙏 I found my spiritual home at RK Properties. Use my referral code ${code} for ₹5,000 off your plot in Braj Dham. Explore: https://rkproperties.in`}
                      target="_blank"
                    ...
                    <a
                      href={`https://www.facebook.com/sharer/sharer.php?u=https://rkproperties.in&quote=Found my spiritual home at RK Properties! Use code ${code} for ₹5000 off.`}
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      href={`https://twitter.com/intent/tweet?text=Found my spiritual home at RK Properties! Use my code ${code} for ₹5000 off plots in Braj Dham. 🙏✨&url=https://rkproperties.in`}
                      target="_blank"
                      rel="noopener noreferrer"
